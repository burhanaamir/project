	...
	<div class="d-flex justify-content-center h-100">
      ...
      <form method="post">
					<div class="input-group form-group">
						...
						<input type="email" class="form-control" placeholder="Email" name="txtname" required>
					...
					<div class="form-group">
						<input type="submit" value="Login" class="btn float-right login_btn" name="btnlog">
					</div>
				</form>
			</div>
...
if(isset($_POST['btnlog']))
{
    ...
    $qu=mysqli_query($con,"select * from users where username='$name' and pass='$pass'");
