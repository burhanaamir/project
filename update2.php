...
if(isset($_POST['btnupd']))
{
    ...
    $s=move_uploaded_file($imgtemplocation,"cardimg/".$img);
           $bname = $_POST["bname"];
           $bdis = $_POST["bdis"];
           $aname= $_POST["aname"];
           $bprice = $_POST["bprice"];
...
$qu = mysqli_query($con,"update featurecard set `bname`='$bname',`bdis`='$bdis',`aname`='$aname',`img`='$img',`bprice`='$bprice',`sprice`='$sprice' where id='$id'");
if($qu)
{
