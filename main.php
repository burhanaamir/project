...
<div class="form-floating mb-3">
                    ...
                    <a href="feature.php"><input type="btn" value="ADD FEATURE PRODUCT " class="btn btn-primary rounded-pill m-2"></a>
                </form>
...
$s=move_uploaded_file($imgtemplocation,"website/cardimgf/".$img);
       $bname = $_POST["bname"];
       $bdis = $_POST["bdis"];
       $aname= $_POST["aname"];
       $bprice = $_POST["bprice"];
       $sprice = $_POST["sprice"];
        ...
        $insert = mysqli_query($con, "INSERT INTO `card`(`id`, `bname`, `bdis`, `aname`, `img`, `bprice`, `sprice`) VALUES ('','$bname','$bdis','$aname','$img','$bprice','$sprice')");
       if($insert > 0){
        echo "data inserted";  
       }else{
